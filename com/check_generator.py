...
def main():
    ...
    parser.add_argument('--out', '-o', default='check',
    ...
    gen = Generator(x_order=2,nof_pack=nof_pack, z_order=args.z_order ,
                    wscale=0.5,
                    nof_hidden=7,hidden_order=20)
